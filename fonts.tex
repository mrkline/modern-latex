...
Apple's \acronym{aat}, but we'll limit ourselves here to a discussion of
the more ubiquitous formats.}
...
shortcuts mentioned in \chapref{punctuation} (e.g., creating en dashes with
...
A typical typeface might come packaged as multiple files for its various
weights and styles.
...
respectively.\footnote{One way to sidestep this issue is to user fewer
...
You can select your figures with the following options:
\begin{leftfigure}
\begin{tabular}{l l}
