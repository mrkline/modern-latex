...
Given the name of the typeface,
\texttt{fontspec} can generally deduce the names of these
...
\item Learn how \texttt{fontspec} can choose between optical sizes based on
    point size, either automatically via OpenType,
