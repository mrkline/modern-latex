...
\item[OpenType] was first released in 1996 by Microsoft and Adobe.
    ...
    multiple versions of glyphs in a single font file---we'll
    see this feature in action throughout much of this chapter.
...
These \introduce{font features} are enabled with optional arguments to
