...
\texttt{``} and \texttt{''} for curly quotes) instead of forcing you
to enter the the corresponding characters,
which probably aren't on your keyboard.
You often don't want these when setting monospaced type, though.
Text that uses it---such as code---is usually meant to be displayed
...
{\fontspec[Scale=MatchLowercase]{FuturaSc-Boo}\textsc{small capitals}},
