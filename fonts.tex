...
Today, \LuaLaTeX{} and \XeLaTeX{} offer support for the formats you're
...
\item[OpenType] was first released in 1996 by Microsoft and Adobe.
    ...
    We'll see this feature in action throughout much of this chapter.
...
you may want to use others for your documents.
...
options. If you want to temporarily disable discretionary ligatures,
\begin{leftfigure}
\begin{lstlisting}
