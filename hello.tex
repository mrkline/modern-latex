...
\texttt{article} is probably a good choice for the average document.
The next line, \verb|% Say hello|,
is a \introduce{comment}---any text placed after \texttt{\%} on a line
...
on your keyboard, your editor, and the language settings in your \acronym{os}.
