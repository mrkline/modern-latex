...
If you are using a \LaTeX{}-specific editor, it should have some method
...
Some commands require parameters, or \introduce{arguments}:
\verb|\documentclass|,
...
We give these demands as optional \verb|\documentclass| arguments:
\begin{leftfigure}
\begin{lstlisting}
...
a brand new line!
\end{leftfigure}
Use this power judiciously---deciding how to elegantly break paragraphs into
