...
Knuth stopped adding features to \TeX{} after
its 3.0 release in March~1990,
...
with the code (in this case, Pascal) interspersed between paragraphs.
This mix of English and code is called \texttt{WEB},
and can be broken up into its constituent parts with companion programs
\texttt{TANGLE} and \texttt{WEAVE}.

Unsurprisingly, most modern systems don't have good tooling for a late 1970s
dialect of Pascal, so present-day \TeX{} distributions use another program,
