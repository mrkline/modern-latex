...
\item[\XeTeX] is a further extension of \TeX{} that adds native Unicode support,
    as well as built-in handling for modern font files, such as OpenType.
...
\item[\LuaTeX] is similar to \XeTeX{} in its native Unicode and modern font support.
    ...
    It also first appeared in 2007, and is developed by a core team of
