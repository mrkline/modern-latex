...
\setmonofont[
    Numbers=SlashedZero,
    % Scaling Fira to the lowercase size of body text makes it a _touch_
    % too thin. That scale is about 0.74, so bump it a few percent and try that.
    UprightFeatures={
        SizeFeatures={
            {Size={-10}, Scale=MatchLowercase, Font=FiraMono-Medium},
            {Size={10-}, Scale=0.76, Font=FiraMono-Regular},
        },
    },
    BoldFeatures={
        SizeFeatures={
            {Size={-10}, Scale=MatchLowercase, Font=FiraMono-Bold},
            {Size={10-}, Scale=0.76, Font=FiraMono-Bold},
        },
    },
]{Fira Mono}
...
\newenvironment{leftfigure}
  {\par\vspace{0.5\baselineskip minus 0.3\baselineskip}\begin{adjustwidth}{22pt}{0pt}}
...
\newenvironment{centerfigure}
  {\par\vspace{0.5\baselineskip minus 0.3\baselineskip}\begin{adjustwidth}{22pt}{22pt}\centering}
  {\end{adjustwidth}\vspace*{0.5\baselineskip minus 0.3\baselineskip}}
...
Changes since the last proof include:
\begin{itemize}
\item The book is now designed for \textsc{a5} paper instead of
    \textsc{us}~\textsc{t}rade.
\item The top margin was increased to \otffrac{3}{4}\,in. \\
    (Forgive this silly American for using \textsc{a5} paper with margins in inches.)
\item The outer margin was increased by \otffrac{1}{20}\,in,
    and the inner margin was decreased by the same amount.
\item Monospaced code listings were grown to match the body text size
    (11\,pt).
\item Minor spacing tweaks were made to the table of contents.
\end{itemize}
\vfill
