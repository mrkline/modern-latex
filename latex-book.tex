...
\setmonofont[
    ...
    UprightFeatures={
        SizeFeatures={
            {Size={-10}, Font=TRY_DriveMono-Medium},
            {Size={10-}, Font=TRY_DriveMono-Book},
        },
    },
    ItalicFeatures={
        SizeFeatures={
            {Size={-10}, Font=TRY_DriveMono-MediumItalic},
...
\begin{itemize}
\item The inner and outer margin were equalized.
    There seems like there will be enough of a gutter if we use 0.6\,in.\ on
    both sides.
\item Yet another read-through of minor edits.
\item We've settled on Drive Mono.
    (A completely random sample of my coworkers voted for it unanimously over
    Fira Mono.)
\item Heavier weight of Drive Mono were used
    (Book for body and Medium for footnotes, instead of
    Regular for body and Book for footnotes).
\end{itemize}
\vfill
