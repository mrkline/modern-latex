...
\documentclass[fontsize=10bp, numbers=endperiod]{scrbook}
...
\usepackage[paperwidth=6in, paperheight=9in,
            inner=0.75in,outer=0.5in,top=0.5in,bottom=0.5in,
            includefoot,
           ]{geometry}
...
\setmainfont[
    ...
    % but stretching it out about 30% gives about the same metrics.
    WordSpace={1.3,1.3,1},
    UprightFeatures={
        SizeFeatures={
...
repository at \\
\url{https://github.com/mrkline/latex-book} \\
Questions, comments, concerns, and diatribes relating to this book 
can also be sent to \\
