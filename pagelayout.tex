...
If you want it to be ``flush left''\quotekern,
...
The \verb|\footnote| command places a footnote marker at its location in the
body text, then inserts argument as a footnote at the bottom of the current
page:
\begin{leftfigure}
\begin{lstlisting}
