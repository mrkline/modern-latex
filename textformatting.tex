...
These are just a few of the many styles you can use.
...
over the second
(which affects the group it's issued in),
since the former automatically fixes up the spacing around
the formatted text.\punckern\footnote{For example,
...
However, the second variety is your only option
...
\begin{leftfigure}
\fontspec{lmroman5-regular} If I magnify 5 point type
\lm so it's as tall as 11 point type,
