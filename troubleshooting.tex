...
Typesetters try to avoid \introduce{widow} and \introduce{orphan}
(also called \introduce{club}) lines,
which appear separated from the rest of their paragraph by a page boundary.
\LaTeX{} tries to avoid these, but its page-splitting algorithm
