...
where what's on screen is the same as what comes out of your
printer.
\LaTeX{} is different. Here, documents are written as
``plain'' text files, using \introduce{markup} to specify
how they should look.
\LaTeX{} then composes your work from these source files,
...
the page you want browsers to draw, your markup describes the
...
\item You can define your own rules, then tweak them to instantly adjust
    ...
    and every place in this book that uses them is immediately updated.
...
\item Show you how to use modern typesetting technologies,
