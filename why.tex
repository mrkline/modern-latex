...
browsers to render, your markup describes the appearance of your document
to \LaTeX{}.
...
to \LaTeX{}.
\end{lstlisting}
\caption{The \LaTeX{} markup for the above paragraph}
\end{figure}
...
\noindent Typography is why this reminds you of all the terrible essays
you wrote in school.
...
\noindent seems oddly reminiscent of a certain shoe company's advertising,
or how
...
(See Appendix~\ref{resources} for some of them.)

Unfortunately, most of these guides have two fatal flaws: they are long,
and they are old.
The first is anathema to newcomers---if somebody asks about \LaTeX{},
throwing a 200+ page book at them isn't an encouraging first step.
The second matters because of how much the world of computer typesetting has
changed.

When \LaTeX{} was first released in 1986, none of the technologies we use today
existed. Adobe wouldn't introduce their Portable Document Format for another
seven years,
and home computers wouldn't support it ubiquitously for several after that.
...
This shows---badly---in most \LaTeX{} guides you find today.
Look for instructions to change your document's font
and become instantly inundated with bespoke nonsense.\punckern\footnote{%
Take all criticisms of \LaTeX's past here with a grain of
salt. After all, the fact that it has had such staying power that
all of the technology around it became obsolete, multiple times, is astounding.}

The good news is that  \LaTeX{} has improved in leaps and bounds in recent years,
