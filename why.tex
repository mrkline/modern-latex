...
With the help of typography, two men landed on a dusty alien plain,
carrying a plaque that looked like this:
\begin{center}
...
And if you care about all of this,
...
\item Being able to save the document as plain text also has advantages:
    \begin{itemize}
...
a 200+ page book at them isn't an encouraging start.
