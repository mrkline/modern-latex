...
In \acronym{wysiwyg} environments,
you must constantly concern yourself with the
\emph{layout} of your work as you write its \emph{contents}.
The more a document grows, the more difficult it becomes keep its appearance
consistent.
...
\begin{enumerate}
\item You can think separately about a document's contents and
    its presentation.
...
\item In \LaTeX, the document's structure is immediately visible
    ...
    (Compare this to \acronym{wysiwyg} systems, where it is often unobvious
