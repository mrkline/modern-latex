...
Good typography isn't just art---it's function---and
\LaTeX\footnote{Pronounced ``lay-tech'' or ``lah-tech''}
enables the everyday person to craft beautifully typeset documents
with little effort.
...
offering the same tools used by professional graphic designers and
publishers.
...
\item You can define your own commands, then tweak them to instantly adjust
    ...
    and every instance immediately takes on the new look.
